    ...
    public boolean onTouch(View view, MotionEvent event) {
        ...
        switch (action & event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                deleteView.animate().alpha(1.0f).setDuration(1000).setListener(new AnimatorListenerAdapter() {
                    @Override
                ...
                onPhotoEditorSDKListener.onTouchDownListener();
                break;
            case MotionEvent.ACTION_MOVE:
                ...
                onPhotoEditorSDKListener.onMoveItemListener();
                break;
            case MotionEvent.ACTION_CANCEL:
                mActivePointerId = INVALID_POINTER_ID;
                onPhotoEditorSDKListener.onTouchUpListener();
                break;
            case MotionEvent.ACTION_UP:
                ...
                deleteView.animate().alpha(0.0f).setDuration(250).setListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animation) {
                        super.onAnimationEnd(animation);
                        deleteView.setVisibility(View.GONE);
